...
urlpatterns = [
    ...
    path('testing_model/select_data/', views.select_data_for_testing, name='select_data_for_testing'),
    path('testing_model/select_model/', views.select_model_for_testing, name='select_model_for_testing'),
    path('testing_model/start_test/', views.start_model_testing, name='start_model_testing'),
    path('profile/password_change/', auth_views.PasswordChangeView.as_view(template_name='password_change.html'), name='password_change'),
    path('profile/password_change/password_change_done/', auth_views.PasswordChangeDoneView.as_view(template_name='password_change_done.html'), name='password_change_done'),
